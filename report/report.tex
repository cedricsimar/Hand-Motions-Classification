...
\textbf{TOUTDOUX}\\
| Geodesic = curve / line of minimal length between two points of the Manifold \\
| Riemannian distance = length of the geodesic \\
\\ \ \\
| Metric of a RM is a function that assign each point P of the Manifold a scalar product in the tangent space. 
We will use the Fisher information as a metric. Fisher information quantify the information of a parameter contained in a distribution. 
Since the metric is a function that quantify the distance between two elements of the Manifold and that the Manifold has the distribution parameters as coordinates, Fisher information metric gives a distance that quantify the difference of information between distributions using different parameters.\\
|\\
\textbf{end of TOUTDOUX}\\
